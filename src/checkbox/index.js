...
const Checkbox = ({ variant, checked, onChange, disabled, ...props }) => {
  ...
  return (<label className={[styles.checkbox].concat(disabledClass).concat(checkedClass).join(' ')}>
    <input data-testid="checkbox" disabled={disabled} type="checkbox" checked={checked} onChange={onChange ? ({ target }) => onChange(target.checked) : /* istanbul ignore next */  null} {...props} />
    {
      variant ?
        <svg width="24px" height="24px" viewBox="0 0 24 24">
          {
            checked ?
              <g data-testid="checked-variant-active" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
              ...
              : <g data-testid="checked-variant-inactive" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        ...
        <svg width="24px" height="24px" viewBox="0 0 24 24">
          {
            checked ?
              <g data-testid="checked-active" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
              ...
              : <g data-testid="checked-inactive" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                <g transform="translate(-2079.000000, -2448.000000)" fill={color}>
                  <path d="M2100,2470 L2082,2470 C2081.45,2470 2081,2469.55 2081,2469 L2081,2451 C2081,2450.45 2081.45,2450 2082,2450 L2100,2450 C2100.55,2450 2101,2450.45 2101,2451 L2101,2469 C2101,2469.55 2100.55,2470 2100,2470 Z M2101,2448 L2081,2448 C2079.9,2448 2079,2448.9 2079,2450 L2079,2470 C2079,2471.1 2079.9,2472 2081,2472 L2101,2472 C2102.1,2472 2103,2471.1 2103,2470 L2103,2450 C2103,2448.9 2102.1,2448 2101,2448 Z" id="checkbox_disabled"></path>
                </g>
              </g>
